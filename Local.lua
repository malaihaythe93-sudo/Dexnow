...
KeyTab:AddButton({
    ...
    Callback = function()
        if KeyInput == CorrectKey then
            ...
            -- Thay vì Destroy, ta ẩn cửa sổ nhập Key đi để tránh lỗi hệ thống Fluent
            KeyWindow:Minimize() 
...
function StartMainScript()
    ...
    Tabs.Combat:AddButton({
        Title = "Kích hoạt nhanh Dex Explorer",
        Description = "Chạy file Dexcode.lua từ GitHub cá nhân của bạn",
        Callback = function()
            loadstring(game:HttpGet("https://raw.githubusercontent.com/malaihaythe93-sudo/Dexnow/refs/heads/main/Dexcode.lua"))()
        end
    })
